...
function Show-InteractiveRemovalPrompt {
    ...
    $PromptForm.Size = [System.Drawing.Size]::new(700, 750)
    $PromptForm.StartPosition = "CenterScreen"
    $PromptForm.FormBorderStyle = "FixedDialog"

    $Header = New-Object System.Windows.Forms.Label
    $Header.Text = "Total Unique Links Found: $($script:AnonymousLinksFound.Count)"; $Header.Location = "20, 20"; $Header.Size = "640, 25"
    $Header.Font = [System.Drawing.Font]::new("Arial", 11, [System.Drawing.FontStyle]::Bold)

    # --- NEW: Summary List Box ---
    $LblSummary = New-Object System.Windows.Forms.Label
    $LblSummary.Text = "Scan Results Summary (File | Owner Site/UPN):"; $LblSummary.Location = "20, 50"; $LblSummary.Size = "500, 20"
    
    $ListSummary = New-Object System.Windows.Forms.ListBox
    $ListSummary.Location = "20, 70"; $ListSummary.Size = "640, 150"
    $ListSummary.Font = [System.Drawing.Font]::new("Consolas", 9, [System.Drawing.FontStyle]::Regular)
    foreach ($item in $script:AnonymousLinksFound) {
        $ListSummary.Items.Add("$($item.FileName.PadRight(40)) | $($item.OwnerSite)")
    }
    ...
    $TxtFile.Location = "20, $($Y+20)"; $TxtFile.Size = "640, 25"
    ...
    $TxtSite.Location = "20, $($Y+20)"; $TxtSite.Size = "640, 25"

    $Y += 60
    $BtnSearch = New-Object System.Windows.Forms.Button
    $BtnSearch.Text = "Search & Review Selected Link"; $BtnSearch.Location = "20, $Y"; $BtnSearch.Size = "640, 40"
    ...
    $TxtResult.Location = "20, $Y"; $TxtResult.Size = "640, 120"; $TxtResult.Multiline = $true; $TxtResult.ReadOnly = $true
    $TxtResult.ScrollBars = "Vertical"

    $Y += 140
    $BtnRevoke = New-Object System.Windows.Forms.Button
    $BtnRevoke.Text = "Revoke Identified Link"; $BtnRevoke.Location = "20, $Y"; $BtnRevoke.Size = "310, 45"
    ...
    $BtnClose.Text = "Exit"; $BtnClose.Location = "350, $Y"; $BtnClose.Size = "310, 45"
    ...
    $PromptForm.Controls.AddRange(@($Header, $LblSummary, $ListSummary, $LblFile, $TxtFile, $LblSite, $TxtSite, $BtnSearch, $TxtResult, $BtnRevoke, $BtnClose))
