...
function Show-InteractiveRemovalPrompt {
    ...
    $PromptForm.Size = [System.Drawing.Size]::new(900, 850)
    $PromptForm.StartPosition = "CenterScreen"
    $PromptForm.FormBorderStyle = "FixedDialog"

    $Header = New-Object System.Windows.Forms.Label
    $Header.Text = "Manage Anonymous Links ($($script:AnonymousLinksFound.Count) Total)"; $Header.Location = "20, 15"; $Header.Size = "840, 25"
    $Header.Font = [System.Drawing.Font]::new("Arial", 11, [System.Drawing.FontStyle]::Bold)

    # --- TOP CONTROLS: Filtering & Selection ---
    $Y = 50
    $LblFilter = New-Object System.Windows.Forms.Label
    $LblFilter.Text = "Filter File:"; $LblFilter.Location = "20, $Y"; $LblFilter.Size = "70, 20"
    ...
    $LblFilterSite.Text = "Filter Site:"; $LblFilterSite.Location = "290, $Y"; $LblFilterSite.Size = "70, 20"
    ...
    $BtnFilter.Text = "Apply Filters"; $BtnFilter.Location = "560, $Y"; $BtnFilter.Size = "100, 25"

    $BtnSelectAll = New-Object System.Windows.Forms.Button
    $BtnSelectAll.Text = "Select All Visible"; $BtnSelectAll.Location = "670, $Y"; $BtnSelectAll.Size = "105, 25"
    
    $BtnDeselectAll = New-Object System.Windows.Forms.Button
    $BtnDeselectAll.Text = "Clear"; $BtnDeselectAll.Location = "780, $Y"; $BtnDeselectAll.Size = "80, 25"
    ...
    $BtnRevoke.Add_Click({
        ...
        if ([System.Windows.Forms.MessageBox]::Show($msg, "Confirm Bulk Revocation", "YesNo") -eq "Yes") {
            ...
            $Header.Text = "Manage Anonymous Links ($($script:AnonymousLinksFound.Count) Total)"
    ...
    $PromptForm.Controls.AddRange(@($Header, $LblFilter, $TxtFilterFile, $LblFilterSite, $TxtFilterSite, $BtnFilter, $BtnSelectAll, $BtnDeselectAll, $Grid, $TxtConsole, $BtnRevoke, $BtnClose))
